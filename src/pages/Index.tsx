        ...
        <section className="relative py-20 lg:py-32 overflow-hidden joker-pattern">
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8 animate-fade-in-up animate-delay-100">
              The ultimate destination for office mischief, digital mayhem, and
              prank perfection. Your coworkers won't know what hit them! 😈
            </p>
          ...
          {/* Floating elements */}
          <div className="absolute top-20 left-10 text-4xl float-animation opacity-20">
            🎭
          </div>
          <div className="absolute bottom-20 right-10 text-4xl float-animation-delayed opacity-20">
            🎪
          </div>
          <div className="absolute top-40 right-20 text-3xl wiggle opacity-20">
            🪲
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Gift the chaos that keeps on giving! 🎁
                  </p>
                </div>
              </div>
              <Link to="/subscription-products">
            ...
            {loadingProducts ? (
              ...
              <div className="text-center py-12 bg-card rounded-xl border">
                ...
                <p className="text-muted-foreground">
                  No subscription pranks available yet... Stay tuned! 😏
                </p>
              </div>
            ) : (
              ...
              {[
                {
                  ...
                  title: "Recurring Mischief",
                  desc: "Subscribe and send pranks on a schedule. The gift that keeps on giving!",
                },
                {
                  icon: <Zap className="h-8 w-8" />,
                  title: "Instant Setup",
                  desc: "Set up your subscription in minutes and start spreading chaos right away!",
                },
                {
                  icon: <ShieldCheck className="h-8 w-8" />,
                  title: "Secure Checkout",
                  desc: "PayPal protected payments. Your prank purchases are safe and sound.",
                },
              ].map((feature, i) => (
                <div
                  key={i}
                  className="bg-card p-6 rounded-xl shadow-card text-center group hover:-translate-y-2 transition-transform">
        ...
        <section className="py-20 bg-gradient-joker text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-xl mx-auto">
              Browse our subscription plans and become the office legend you
              were meant to be!
            </p>
            <Link to="/subscription-products">
