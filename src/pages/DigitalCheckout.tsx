...
export default function DigitalCheckout() {
  ...
  useEffect(() => {
    if (user && id) {
      Promise.all([fetchProduct(), fetchProfile()]).then(() =>
        setLoading(false)
      );
    }
  }, [user, id]);
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 container mx-auto px-4 py-12 text-center">
          ...
          <p className="text-muted-foreground mb-8">
            This digital product doesn't exist.
          </p>
            ...
            <div className="bg-card border rounded-xl p-6">
              ...
              <div className="min-h-[150px] relative">
                ...
                <div
                  ...
                  className={!paypalLoaded ? "hidden" : ""}></div>
              </div>

              <p className="text-xs text-muted-foreground text-center mt-4">
                Your payment is secured by PayPal. You'll receive instant access
                after payment.
              </p>
            </div>
          </div>
