        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white dark:bg-stone-900 rounded-2xl shadow-lg p-8 border border-stone-200 dark:border-stone-800">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="font-display text-3xl text-stone-900 dark:text-stone-100">Terms of Use</h1>
            </div>
            ...
            <div className="prose prose-sm max-w-none space-y-4 text-stone-600 dark:text-stone-400">
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">1. Eligibility and Access</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">2. Nature of the Site and Services</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">3. Anonymous Gifting and Prank Responsibility</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">4. User Information and Privacy</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">5. Marketing and Communications Consent</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">6. TCPA and Electronic Communications</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">7. User Conduct</h2>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">8. No Claims Based on Subjective Reaction</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">9. Intellectual Property and Submissions</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">10. Disclaimer of Warranties</h2>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">11. Limitation of Liability</h2>
              <p className="uppercase font-medium">
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">12. Indemnification</h2>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">13. Termination</h2>
              <p>
                We may suspend or terminate access to the Site at any time, with or without notice, for any reason.
              </p>

              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">14. Governing Law and Venue</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">15. Changes to These Terms</h2>
              <p>
                We may modify these Terms at any time. Continued use of the Site constitutes acceptance of the revised Terms.
              </p>

              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">16. Acknowledgment</h2>
              <p>
                By using the Site, you confirm that you have read, understood, and agree to these Terms of Use.
              </p>

              <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100 mt-6">17. Contact Information</h2>
              <p>
                For questions regarding these Terms, contact: <a href="mailto:Info@corporatepranks.com" className="text-amber-600 hover:underline">Info@corporatepranks.com</a>
              </p>
            </div>
          </div>
        </div>
